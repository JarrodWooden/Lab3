...
while3:
	...
	jz		while3						; Yes, branch back and wait

	dec		R11
	dec		R11
	dec		R11
	dec		R11
	dec		R11						; just let the columm overflow after 92 buttons
	mov		R10, R12					; increment the row
	mov		R11, R13					; and column of the next beam
	call	#setAddress					; we draw
...
while4:
	...
	jz		while4						; Yes, branch back and wait
...
while5:
	...
	jz		while5						; Yes, branch back and wait

	dec		R10							; since rows are 8 times bigger than columns
	mov		R10, R12					; increment the row
	mov		R11, R13					; and column of the next beam
	call	#setAddress					; we draw
